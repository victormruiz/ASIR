...
(
	...
	constraint ck_dni CHECK((DNI ~ '[0-9]{8}[A-Z]') OR (DNI ~ '[KLMX-Z][0-9]{7}[A-Z]'))
);
...
(
	...
	constraint ck_nifc CHECK((NIFCliente ~ '[0-9]{8}[A-Z]') OR (NIFCliente ~ '[KLMX-Z][0-9]{7}[A-Z]'))
);
...
(
	...
	constraint ck_nifp CHECK((NIF ~ '[0-9]{8}[A-Z]') OR (NIF ~ '[KLMX-Z][0-9]{7}[A-Z]'))
);
...
(
	...
	constraint ck_DiaCarrera CHECK(TO_CHAR(FechaHora, 'D') != '0')
);
...
(
	...
	CodCarrera VARCHAR(4),
	CodigoCaballo VARCHAR(4),
	ImporteApostado DECIMAL(7, 2),
	TantoAUnoReal INTEGER,
...
values('0001', '005', TO_TIMESTAMP('02/01/2018 09:30', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0001', '003', TO_TIMESTAMP('02/01/2018 10:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0002', '001', TO_TIMESTAMP('02/01/2018 10:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0002', '007', TO_TIMESTAMP('03/01/2018 10:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0003', '002', TO_TIMESTAMP('04/01/2018 12:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0003', '004', TO_TIMESTAMP('05/01/2018 10:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0004', '006', TO_TIMESTAMP('05/01/2018 12:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0004', '002', TO_TIMESTAMP('10/01/2018 09:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0005', '001', TO_TIMESTAMP('12/01/2018 09:30', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0005', '001', TO_TIMESTAMP('12/01/2018 17:30', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0006', '005', TO_TIMESTAMP('17/01/2018 13:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0006', '008', TO_TIMESTAMP('17/01/2018 19:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0007', '007', TO_TIMESTAMP('18/01/2018 09:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0007', '002', TO_TIMESTAMP('18/01/2018 11:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0008', '005', TO_TIMESTAMP('18/01/2018 12:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0008', '005', TO_TIMESTAMP('18/01/2018 17:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0009', '003', TO_TIMESTAMP('19/01/2018 10:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0009', '004', TO_TIMESTAMP('20/01/2018 09:00', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0010', '006', TO_TIMESTAMP('24/01/2018 14:45', 'DD/MM/YYYY HH24:MI'));
insert into cuadrante(CodigoCaballo, CodCuadra, FechaHora)
values('0010', '008', TO_TIMESTAMP('24/01/2018 17:30', 'DD/MM/YYYY HH24:MI'));
...
values('0001', TO_TIMESTAMP('21/01/2018 09:30', 'DD/MM/YYYY HH24:MI'), 7000, 3500, TO_DATE('01/01/2013', 'DD/MM/YYYY'), TO_DATE('01/08/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0002', TO_TIMESTAMP('21/01/2018 10:00', 'DD/MM/YYYY HH24:MI'), 7875, 3500, TO_DATE('01/01/2012', 'DD/MM/YYYY'), TO_DATE('28/01/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0003', TO_TIMESTAMP('21/01/2018 12:30', 'DD/MM/YYYY HH24:MI'), 14000, 9000, TO_DATE('01/02/2013', 'DD/MM/YYYY'), TO_DATE('31/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0004', TO_TIMESTAMP('21/01/2018 13:30', 'DD/MM/YYYY HH24:MI'), 7000, 3500, TO_DATE('01/01/2013', 'DD/MM/YYYY'), TO_DATE('31/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0005', TO_TIMESTAMP('28/01/2018 09:30', 'DD/MM/YYYY HH24:MI'), 7875, 3500, TO_DATE('01/01/2012', 'DD/MM/YYYY'), TO_DATE('31/10/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0006', TO_TIMESTAMP('28/01/2018 10:00', 'DD/MM/YYYY HH24:MI'), 8750, 4500, TO_DATE('01/01/2013', 'DD/MM/YYYY'), TO_DATE('03/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0007', TO_TIMESTAMP('28/01/2018 10:30', 'DD/MM/YYYY HH24:MI'), 7200, 3500, TO_DATE('10/01/2013', 'DD/MM/YYYY'), TO_DATE('03/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0008', TO_TIMESTAMP('28/01/2018 12:00', 'DD/MM/YYYY HH24:MI'), 8000, 4500, TO_DATE('01/02/2013', 'DD/MM/YYYY'), TO_DATE('01/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0009', TO_TIMESTAMP('04/02/2018 10:00', 'DD/MM/YYYY HH24:MI'), 8000, 4500, TO_DATE('01/05/2012', 'DD/MM/YYYY'), TO_DATE('05/05/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0010', TO_TIMESTAMP('04/02/2018 11:30', 'DD/MM/YYYY HH24:MI'), 8750, 4500, TO_DATE('01/01/2013', 'DD/MM/YYYY'), TO_DATE('31/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0011', TO_TIMESTAMP('04/02/2018 12:45', 'DD/MM/YYYY HH24:MI'), 7700, 3500, TO_DATE('01/02/2013', 'DD/MM/YYYY'), TO_DATE('20/12/2013', 'DD/MM/YYYY'));
insert into carrerasprofesionales(CodCarrera, FechaHora, ImportePremio, LimiteApuesta, FechaNacMin, FechaNacMax)
values('0012', TO_TIMESTAMP('04/02/2018 13:30', 'DD/MM/YYYY HH24:MI'), 11350, 9000, TO_DATE('01/01/2012', 'DD/MM/YYYY'), TO_DATE('31/12/2013', 'DD/MM/YYYY'));
...
insert into apuestas(NIFCliente, CodCarrera, CodigoCaballo, ImporteApostado, TantoAUnoReal)
values('34372081F', '0001', '0001', 60, 10);