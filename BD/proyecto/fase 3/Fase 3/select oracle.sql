...
select MatriculaBarco, ReferenciaCaladero,sysdate,sysdate + 15
...
AND cd.FechaPescaFin > ADD_MONTHS(SYSDATE,-6)
group by DNIArmador;
...
from CAPTURAS_DIARIAS
where FechaPescaFin > add_months(sysdate, - 12)
...
from FAENAS_BARCOS
where TO_CHAR(FechaInicio, 'YYYY') IN ('2013','2014','2015')
...
AND ProximoPago > add_months(sysdate, - 19)
...
from FAENAS_BARCOS
where fechaInicio > add_months(sysdate, - 24);
